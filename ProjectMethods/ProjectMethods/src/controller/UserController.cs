...
namespace ProjectMethods.controller
{
    ...
    {
		public static string userSelectInterface(UserData newUser, Boolean existingUser)
        {
        ...
        public static void userLogin(Boolean existingUser, Boolean logout, Boolean bookAgain,
		...
		public static void userCreatingReservationInterface(Boolean existingUser, Boolean logout, Boolean bookAgain,
									 Boolean confirm, UserData employee,
									 InventoryService inventoryService,
									 TransactionService transactionService, NotificationService notificationService,
									 Ticket ticket, Route newRoute, UserData newUser)
        {
			...
			while (!logout)
			{
				...
				TransactionController.transactionInterface(existingUser, logout, bookAgain, confirm, employee, inventoryService,
								  transactionService, notificationService, ticket, newRoute, newUser);

				// Make Notification, go to user existing flights
				userBookingSelectInterface(existingUser, logout, bookAgain, confirm, employee, inventoryService,
								  transactionService, notificationService, ticket, newRoute, newUser);
		...
		public static void userBookingSelectInterface(Boolean existingUser, Boolean logout, Boolean bookAgain,
									 Boolean confirm, UserData employee,
									 InventoryService inventoryService,
									 TransactionService transactionService, NotificationService notificationService,
									 Ticket ticket, Route newRoute, UserData newUser)
